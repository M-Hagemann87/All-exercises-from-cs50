...
############
###########
    = reader.readrow({"DNA": reader, "STR": str_count})

    reader = csv.reader(file, fieldnames=["DNA", "STR"])
    longest_match(sequence, subsequence) = reader.readrow({"DNA": reader, "STR": str_count})
